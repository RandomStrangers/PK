...
namespace PattyKaki.Network
{
    public class ClassicProtocol : IGameSession
    {
        ...
        public override string ClientName()
        {
            ...
            if (version == Server.VERSION_0016) return "Classic v0.0.16";
            if (version == Server.VERSION_0017) return "Classic v0.0.17-v0.0.18";
            if (version == Server.VERSION_0019) return "Classic v0.0.19";
            if (version == Server.VERSION_0020) return "Classic v0.0.20-v0.0.23";
