...
namespace PattyKaki.Core
{
    public static class MiscHandlers
    {
        ...
        public static void HandleSentMap(Player p, Level _, Level level)
        {
        ...
        public static void HandlePlayerClick(Player p, MouseButton _, MouseAction action, ushort __, ushort ___,
                                               byte entity, ushort x, ushort y, ushort z, TargetBlockFace ____)
        {
