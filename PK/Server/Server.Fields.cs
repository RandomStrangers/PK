...
namespace PattyKaki
{
    public sealed partial class Server
    {
        ...
        public static event OnPKCommand PKCommand;
        ...
        public const byte MAX_PLAYERS = byte.MaxValue;

        public static Scheduler MainScheduler = new Scheduler("PK_MainScheduler");
        public static Scheduler Background = new Scheduler("PK_BackgroundScheduler");
        public static Scheduler Critical = new Scheduler("PK_CriticalScheduler");
        public static Scheduler Heartbeats = new Scheduler("PK_HeartbeatsScheduler");
