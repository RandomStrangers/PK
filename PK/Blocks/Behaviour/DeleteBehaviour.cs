 ...
 */
using System;
using PattyKaki.Blocks.Extended;
using PattyKaki.Blocks.Physics;
using PattyKaki.Maths;
using BlockID = System.UInt16;

namespace PattyKaki.Blocks
{

    public static class DeleteBehaviour
    {

        public static ChangeResult RocketStart(Player p, BlockID _, ushort x, ushort y, ushort z)
        {
        ...
        public static ChangeResult Firework(Player p, BlockID _, ushort x, ushort y, ushort z)
        {
        ...
        public static ChangeResult C4Det(Player p, BlockID _, ushort x, ushort y, ushort z)
        {
        ...
        public static ChangeResult RevertDoor(Player _, BlockID __, ushort ___, ushort ____, ushort _____)
        {
            return ChangeResult.Unchanged;
        }
        ...
        public static ChangeResult DoPortal(Player p, BlockID _, ushort x, ushort y, ushort z)
        {
        ...
        public static ChangeResult DoMessageBlock(Player p, BlockID _, ushort x, ushort y, ushort z)
        {
