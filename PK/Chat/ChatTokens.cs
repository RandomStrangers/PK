...
namespace PattyKaki
{
    ...
    public static class ChatTokens
    {
        ...
        public static List<ChatToken> Standard = new List<ChatToken>() {
            ...
            new ChatToken("$status", "Status of PattyKaki", TokenHost),
            new ChatToken("$host", "Status of PattyKaki", TokenHost),
        };
        public static string TokenHost(Player p) { return Server.Config.PKState; }
