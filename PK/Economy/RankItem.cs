...
{   
    ...
    {    
        ...
        public override void Parse(string prop, string value) {
            ...
            LevelPermission perm = Group.ParsePermOrName(args[0], LevelPermission.PattyKaki);
            if (perm == LevelPermission.PattyKaki) return;
        ...
        public override void OnPurchase(Player p, string args) {
            ...
            Command.Find("SetRank").Use(Player.PK, p.name + " " + rank.Name);
